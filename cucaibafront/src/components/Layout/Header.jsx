                    ...
                    <div className="col-3 d-flex justify-content-end align-items-center">
                        <div className="dropdown">
                            ...
                            <div className="dropdown-user dropdown-menu pt-4" aria-labelledby="dropdownMenu">
                                ...
                                <div className="dropdown-item text-secondary text-center py-3" type="button">
                                    Centro De Alta Complejidad Cardiovascular Presidente Juan Domingo Peron
                                </div>
                                <div className="dropdown-divider mb-2"></div>
                                <div className="dropdown-item text-center" type="button">
                                    <a id="closeSession" className="btn btn-danger close-session w-50" href="/cucaibabonif/trunk/public/index.php/logout" data-url="/cucaibabonif/trunk/public/index.php/logout">Salir</a>
                                </div>
                            </div>
                        </div>
                    </div>
