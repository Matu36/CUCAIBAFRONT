...
export const getAgentes = () => async (dispatch) => {
  let response = await axios.get("http://localhost/CUCAIBABACK/cucaibaback/public/index.php/agentes");
  return dispatch({ type: GET_AGENTES, payload: response.data });
};

export const getOperativos = () => async (dispatch) => {
  let response = await axios.get("http://localhost/CUCAIBABACK/cucaibaback/public/index.php/operativos");
